...
to developcure
  set cure-development (cure-development + (cure-development-rate / 1000 * count humans with [doctor = blue ]))
    ; Maggie 1/11/2017
end
to cure
  ask zombies-here [
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot cure-development"
...
but i ain't done much of healing
heelllooooo
@#$#@#$#@
default
true
