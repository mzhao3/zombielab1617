...
humans-own [ stamina builder hunter doctor nextcolor pleb infected? safecolor infectionlength];notded?
...
to hunter-behavior
  ...
  [
    if any? zombies in-cone hunter-kill-radius 360
    [
 ask one-of zombies in-cone hunter-kill-radius 360
    [die]
    ]
  ]
end
...
to developcure
    set cure-development (cure-development + (cure-development-rate / 100) ) * count (humans with [doctor = blue])
    ; Maggie 1/11/2017
end
to cure
  ask zombies-here [
