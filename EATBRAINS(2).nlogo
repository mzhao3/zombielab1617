...
humans-own [ stamina role builder hunter doctor nextcolor pleb infected? ]
...
to doctor-behavior
  set cure-development (cure-development + (cure-development-rate / 10000) * count (humans with [role = doctor]))
  end
